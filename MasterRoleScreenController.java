...
public class MasterRoleScreenController {
	...
	public ResponseEntity<Map<String, Object>> getAllScreensByRoleId(@PathVariable Long roleId,
		...
		try {
			...
			Page<MasterRoleScreenEntity> screensPage = masterRoleScreenService.getAllScreensByRoleId(roleId, pageable);
			List<MasterRoleScreenEntity> screens = screensPage.getContent();
